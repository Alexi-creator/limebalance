...
export class IncomeCategoriesService {
  ...
  async statsByCategory(
    ...
    return categories.map((c) => {
      ...
      const approxTotal = this.currency.approxTotalInBase(groups, baseCurrency, rates, 'income');
      const base = {
        id: c.id,
        name: c.name,
        emoji: c.emoji,
      ...
      const previousApproxTotal = this.currency.approxTotalInBase(prevGroups, baseCurrency, rates, 'income');
